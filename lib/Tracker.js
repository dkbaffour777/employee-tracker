...
const track_emp = new Employee();
const track_dept = new Department();
const track_role = new Role();
                ...
                execute: () => {
                    connection.query('SELECT id, title FROM roles', (err, rows, fields) => {
                        ...
                        connection.query('SELECT id, CONCAT(first_name, " ", last_name) AS name FROM employees', (err, rows, fields) => {
                            ...
                            track_emp.updateEmployeeRole(questions);
                        });
                    });
                }
            },
                ...
                execute: () => {
                    connection.query('SELECT id, CONCAT(first_name, " ", last_name) AS name FROM employees', (err, rows, fields) => {
                        ...
                        connection.query('SELECT id, CONCAT(first_name, " ", last_name) AS name FROM employees', (err, rows, fields) => {
                            ...
                            track_emp.updateEmployeeManager(questions);
                        });
                    });
                }
            },
            {
                ...
                execute: () => {
                    connection.query('SELECT id, name FROM departments', (err, rows, fields) => {
                        ...
                        track_dept.deleteDepartment(questions);
                    });
                }
            },
            {
                ...
                execute: () => {
                    connection.query('SELECT id, title FROM roles', (err, rows, fields) => {
                        ...
                        track_role.deleteRole(questions);
                    });
                }
            },
            {
                ...
                execute: () => {
                    connection.query('SELECT id, CONCAT(first_name, " ", last_name) AS name FROM employees', (err, rows, fields) => {
                        ...
                        track_emp.deleteEmployee(questions);
                    });
                }
            },
        ]
